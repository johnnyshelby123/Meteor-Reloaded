     ...
     public void build(LiteralArgumentBuilder<CommandSource> builder) {
         ...
         builder.then(literal("players").executes(ctx -> {
             ...
             for (var playerEntry : playerList) {
                 ...
                 // Calculate distance if player entity exists in the world
                 String distance = "Unknown";
                 var playerEntity = mc.world.getPlayerByUuid(playerEntry.getProfile().getId());
                 if (playerEntity != null && mc.player != null) {
                     double distanceValue = mc.player.getPos().distanceTo(playerEntity.getPos());
